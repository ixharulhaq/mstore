    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Select From Below:</h6>
            <a class="collapse-item" href="invoices.php">Invoices Entry</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTables" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="invoicestable.php">Invoices Table</a>
            
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Add New Tables:</h6>
            <a class="collapse-item" href="companiestable.php">Companies Table</a>
